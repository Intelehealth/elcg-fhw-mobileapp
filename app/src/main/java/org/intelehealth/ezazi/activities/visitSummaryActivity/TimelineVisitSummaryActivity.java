...
//            String[] nurseUUID = new String[mProviderNurseList.size() - 1];
    ...
    private void showDoctorSelectionDialog(boolean isChat) {
        LinkedList<SingChoiceItem> choiceItems = AppRegion.supportsMultiVisit() ? CallInitializer.getDoctorsDetails(visitUuid) : CallInitializer.getDoctorsDetailsByPatUid(patientUuid);
